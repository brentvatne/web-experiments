...
angularFileUpload.directive('ngFileDrop', [ '$parse', '$timeout', '$location', function($parse, $timeout, $location) {
  return function(scope, elem, attr) {
    if ('draggable' in document.createElement('span')) {
      ...
      var isFileTransfer = function(event) {
        return (event.dataTransfer.types[0] == "Files");
      }

      // Add the dragover class
      elem[0].addEventListener("dragover", function(evt) {
        // Only run this callback if dataTransfer
      ...
      // Remove the dragover class when you leave the area
      ...
      // ** Need to support multiple types of drop events: are we dropping
      // a file from outside of the browser or an existing element?
